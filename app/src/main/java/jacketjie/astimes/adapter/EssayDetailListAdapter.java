 ...
 */
public class EssayDetailListAdapter extends CommonAdapter<EssayDetail> {
    private ImageSize imageSize;

    public EssayDetailListAdapter(Context context, List<EssayDetail> mDatas, int itemLayoutId) {
